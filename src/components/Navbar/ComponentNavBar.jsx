      ...
      <Container className='containerNav'>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto ">
            <Nav.Link href="/" className='LinksNav'>Registrarse</Nav.Link>
            <Nav.Link href="/SobreNosotros" className='LinksNav'>Sobre Nosotros</Nav.Link>
            <NavDropdown title="Mas" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="#action/3.3" className='LinksMas'>Especialidades</NavDropdown.Item>
            </NavDropdown>
          </Nav>
        </Navbar.Collapse>
      </Container>
