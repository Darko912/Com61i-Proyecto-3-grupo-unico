  ...
  return (
    <div>
      ...
      <div className='row justify-content-center'>
        ...
        <Card.Text>
          <p>
          hola me llamo Bruno Casavalle, soy un apasionado de la computacion y tambien de los deportes, estoy estudiando en la UTN la tecnicatura en programacion y soy un estudiante de rolling</p>
